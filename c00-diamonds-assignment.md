...
**Observations**:
  ...
  - Around 3 carats to 5 carats, there’s significantly less data points.
  - The graph is more spread out from 1 carat.
  - Price is generally increased with carat.
...
**Observations**:
  ...
  - Ideal cut tends to be more expensive, and fair cut tends to me more
    cheap.
  - Price is generally increased with carat.
  - There’s more data of ideal or premium cut when the value of carat is
    small.
  - Having different colors in the graph make it more easier to observe
    the data compared to the previous graph with only one color.
